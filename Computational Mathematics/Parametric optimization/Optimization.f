...
1000	continue
   ...
   30 PRINT 35
   35 FORMAT(/20X,48HéHTEçPéPOBAHéE ðPEPBAHO, ðOCKOìøKõ ðOìøúOBATEìø ,
     *11HHE BùðOìHéì/20X,34HéHCTPõKãéê RKF45, COOTBETCTBõàýéX ,
     *27HúHAþEHéñM IFLAG=5,6,7 éìé 8)
      STOP
   40 NFE=0
